//
// DO NOT MODIFY THIS FILE! It is auto-generated from src/data/wild_encounters_frlg.json and Inja template src/data/wild_encounters_frlg.json.txt
//
...
const struct WildPokemonHeader gWildMonHeadersFRLG[] =
{
    {
